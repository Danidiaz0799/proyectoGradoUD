...
TOPIC_MOTOR = 'raspberry/motor'  # Topico para controlar el motor
TOPIC_GY302 = "sensor/gy302"
TOPIC_SHT3X = "sensor/sht3x"  # Topico donde se publicaran los datos del sensor SHT3x
